...
public class WeeklyParkingSpotTests
{
    ...
    public void given_invalid_date_add_reservation_should_fail(string dateString)
    {
        ...
        var reservation = new VehicleReservation(Guid.NewGuid(), "John Doe", "ABC123", new Date(invalidDate));
    ...
    {
        var reservation = new VehicleReservation(Guid.NewGuid(), "John Doe", "ABC123", _now.AddDays(1));
